export default function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-gray-100 text-gray-800 hover:bg-gray-200 border border-gray-200 rounded-xl px-5 py-3',
    outline: 'border border-gray-200 text-gray-800 hover:bg-gray-50 rounded-xl px-5 py-3',
    pill: 'bg-black text-white hover:bg-gray-800 rounded-full px-5 py-2.5 text-sm',
    pillOutline: 'border border-gray-200 text-gray-800 hover:bg-gray-50 rounded-full px-5 py-2.5 text-sm',
  ...
  return (
    ...
    >
      {loading ? (
        <span className="w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin mr-2" role="status" aria-label="Loading"></span>
      ) : Icon ? (
